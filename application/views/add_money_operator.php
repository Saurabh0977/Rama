...
<!-- Basic layout-->
        ...
        <!-- Basic layout-->
        <form action="<?php echo base_url();?>Users/add_money_operator" method="post" enctype="multipart/form-data">
            <div class="card">
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" name="sdate" class="form-control" value = "<?php echo date('Y-m-d'); ?>" disabled>
                    </div>
